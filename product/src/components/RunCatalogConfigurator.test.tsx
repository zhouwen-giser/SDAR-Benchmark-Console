...
describe("RunCatalogConfigurator", () => {
  it("keeps server-driven subset order editable", () => {
    ...
    render(<RunCatalogConfigurator
      presets={[{ id: "regression/0.2", label: "Regression", datasetVersionRef: "dataset/0.2", candidateSnapshotRef: "candidate/0.2", selectedCaseIds: ["UGV-NODE-002", "UGV-CORE-003"], repeatCount: 3, dataClass: "development_substituted" }]}
