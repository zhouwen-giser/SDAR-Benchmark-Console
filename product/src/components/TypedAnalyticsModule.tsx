...
const fieldsByModule: Record<string, string[]> = {
  ...
  skills: ["skillId", "skillVersion", "invocationCount", "terminalCount", "statusCounts", "durationStats", "dataClass"],
  providers: ["providerId", "providerInstanceId", "operation", "taskCount", "executionCount", "missionCount", "closureStatus", "dataClass"],
  ...
  "score-distribution": ["observationCount", "p10", "p25", "median", "p75", "p90", "availability", "reasonCodes", "dataClass"],
