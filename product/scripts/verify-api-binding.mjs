...
if (operationCount !== lock.operationCount || operationCount !== 125) throw new Error(`Expected 125 operations, found ${operationCount}`);
if (new Set(operationIds).size !== 125) throw new Error(`Expected 125 unique operationIds, found ${new Set(operationIds).size}`);
